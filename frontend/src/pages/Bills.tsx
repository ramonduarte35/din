      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4">
        ...
        <Card className="p-4 sm:p-5 border-border bg-card flex items-center justify-between shadow-lg">
          <div className="min-w-0 flex-1 pr-2">
            <span className="text-xs text-din-muted font-semibold uppercase tracking-wider block">A Pagar</span>
            <p className="text-xl sm:text-2xl font-bold font-mono text-amber-500 mt-1 whitespace-nowrap">
              {maskValue(summary?.total_pending?.amount || 0)}
            </p>
            <p className="text-xs text-din-muted mt-1 block">
              {summary?.total_pending?.count || 0} {summary?.total_pending?.count === 1 ? 'conta pendente' : 'contas pendentes'}
            </p>
          </div>
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-amber-500/15 border border-amber-500/30 flex items-center justify-center text-amber-500 shadow-md shrink-0">
        ...
        <Card className={`p-4 sm:p-5 border flex items-center justify-between shadow-lg ${
          ...
          <div className="min-w-0 flex-1 pr-2">
            <span className="text-xs text-red-400 font-semibold uppercase tracking-wider block">Vencidas</span>
            <p className="text-xl sm:text-2xl font-bold font-mono text-red-400 mt-1 whitespace-nowrap">
              {maskValue(summary?.total_overdue?.amount || 0)}
            </p>
            <p className="text-xs text-red-300/70 mt-1 block">
              {summary?.total_overdue?.count || 0} {summary?.total_overdue?.count === 1 ? 'conta atrasada' : 'contas atrasadas'}
            </p>
          </div>
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-red-500/15 border border-red-500/30 flex items-center justify-center text-red-400 shadow-md shrink-0">
        ...
        <Card className="p-4 sm:p-5 border-border bg-card flex items-center justify-between shadow-lg">
          <div className="min-w-0 flex-1 pr-2">
            <span className="text-xs text-din-muted font-semibold uppercase tracking-wider block">Pago</span>
            <p className="text-xl sm:text-2xl font-bold font-mono text-emerald-500 mt-1 whitespace-nowrap">
          ...
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-500 shadow-md shrink-0">
