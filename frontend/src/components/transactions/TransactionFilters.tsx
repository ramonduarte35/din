...
export function TransactionFiltersBar({
  ...
  return (
    <div className="p-4 rounded-2xl bg-card border border-border backdrop-blur-md space-y-3">
      {/* Chips de Seleção Rápida */}
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none text-xs">
        <span className="text-din-muted font-medium mr-1 flex items-center gap-1 flex-shrink-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <div className="relative lg:col-span-2">
          <Search className="w-4 h-4 text-din-muted absolute left-3.5 top-1/2 -translate-y-1/2" />
          <input
            type="text"
            placeholder="Buscar por descrição..."
            value={filters.search || ''}
            onChange={(e) => onChange({ ...filters, search: e.target.value, page: 1 })}
            className="w-full bg-card-secondary border border-border rounded-xl pl-10 pr-3.5 py-2 text-xs text-din-text placeholder:text-din-muted/60 focus:outline-none focus:ring-2 focus:ring-din-primary/40 focus:border-din-primary"
          />
        </div>
        ...
        <div>
          <select
            ...
            className="w-full bg-card-secondary border border-border rounded-xl px-3 py-2 text-xs text-din-text focus:outline-none focus:ring-2 focus:ring-din-primary/40 focus:border-din-primary"
          >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-border text-xs">
        <div className="flex items-center gap-2 flex-wrap">
          <span className="text-din-muted flex items-center gap-1 font-medium">
          ...
          <input
            ...
            className="bg-card-secondary border border-border rounded-lg px-2.5 py-1 text-xs text-din-text"
          />
          <span className="text-din-muted">até</span>
          <input
            type="date"
